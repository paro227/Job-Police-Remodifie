...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = '<span style="color:#3992FF;">Status de l\'agent <span style="color:cyan;">', value = 'status'},
			{label = '<span style="color:#3992FF;">Intéraction citoyen <span style="color:cyan;">', value = 'citizen_interaction'},
			{label = '<span style="color:#3992FF;">Intéraction véhicule <span style="color:cyan;">', value = 'vehicle_interaction'},
			{label = '<span style="color:#3992FF;">Menu menottes<span style="color:cyan;">', value = 'menu_menottes'},			
			--{label = '<span style="color:#3992FF;">Menu objets <span style="color:cyan;">', value = 'object_spawner'},
			--{label = '<span style="color:#3992FF;">Equipement LSPD<span style="color:cyan;">', value = 'lspd_equipement'},
			{label = '<span style="color:#3992FF;">Donner une amende<span style="color:cyan;">', value = 'ammende'},
			{label = '<span style="color:#3992FF;">Demande renfort<span style="color:cyan;">', value = 'renfort'},
			{label = '<span style="color:#3992FF;">Sortir bouclier<span style="color:cyan;">', value = 'spawn_bouclier'},
			{label = '<span style="color:#3992FF;">Ranger bouclier<span style="color:cyan;">', value = 'remove_bouclier'},
			{label = '<span style="color:#3992FF;">Bracelets GPS<span style="color:cyan;">', value = 'braceletsgps'},
			{label = '<span style="color:#3992FF;">Droit miranda<span style="color:cyan;">', value = 'miranda'},
			{label = '<span style="color:#3992FF;">Radar mobile<span style="color:cyan;">', value = 'rd_mobile'},
			{label = '<span style="color:#3992FF;">Menu chien<span style="color:cyan;">', value = 'chienpolice'},
			{label = '<span style="color:#3992FF;">Montrer son badge<span style="color:cyan;">', value = 'badge'}
			
	}}, function(data, menu)
	
		if data.current.value == 'braceletsgps' then
            ExecuteCommand ('bracelets')
		end
		
		if data.current.value == 'miranda' then
            ExecuteCommand ('miranda')
			ESX.UI.Menu.CloseAll()
		end
		...
		if data.current.value == 'chienpolice' then
